...
RULES = [
    ...
    # ── Дальние цели: чтобы было куда расти после первого месяца ──
    ("h1000",         "🚀", "Тысячник",           "1000 часов в проектах",              "total_s",        1000 * H),
    ("marathon8",     "🦾", "Ультрамарафон",      "Одна сессия длиннее 8 часов",        "longest_s",      8 * H),
    ("streak50",      "⚔️", "Полсотни подряд",    "50 дней подряд с активностью",       "overall_streak", 50),
    ("streak100",     "👑", "Столетний огонь",    "100 дней подряд с активностью",      "overall_streak", 100),
    ("days100",       "🗓️", "Сотня дней",         "100 разных дней с активностью",      "active_days",    100),
    ("days365",       "🎂", "Год в деле",         "365 разных дней с активностью",      "active_days",    365),
    ("sessions100",   "🎖️", "Центурион",          "100 завершённых сессий",             "sessions",       100),
    ("sessions500",   "🏅", "Пятьсот сессий",     "500 завершённых сессий",             "sessions",       500),
    ("scribe50",      "📜", "Хронист",            "50 заметок к сессиям",               "notes",          50),
    ("collector10",   "🏛️", "Магнат",             "10 проектов в библиотеке",           "projects",       10),
    ("goals3",        "🏹", "Снайпер",            "3 достигнутые цели по часам",        "goals_reached",  3),
    ("night10",       "🌙", "Полуночник",         "10 сессий, законченных после полуночи", "night_sessions", 10),
]
